...
export const topComics2025: ComicSeries[] = [
  {
    rank: 1,
    series_name: "Assorted Crisis Events",
  ...
  {
    rank: 3,
    series_name: "Minor Arcana",
    publisher: "BOOM! Studios",
    writer: "Jeff Lemire",
    artists: ["Jeff Lemire"],
    colorists: ["Jeff Lemire"],
  ...
  {
    rank: 5,
    series_name: "Universal Monsters: The Invisible Man",
  ...
  {
    rank: 6,
    series_name: "Invincible Universe: Battle Beast",
    publisher: "Image Comics/Skybound",
    writer: "Robert Kirkman",
    artists: ["Ryan Ottley"],
    colorists: ["Annalisa Leoni"],
    letterers: [],
  ...
  {
    rank: 8,
    series_name: "Phantom Road",
    publisher: "Image Comics",
    writer: "Jeff Lemire",
    artists: ["Gabriel Hernández Walta"],
    colorists: ["Jordie Bellaire"],
    letterers: ["Steve Wands"],
  ...
  {
    rank: 9,
    series_name: "We're Taking Everyone Down With Us",
    publisher: "Image Comics",
    writer: "Matthew Rosenberg",
    artists: ["Stefano Landini"],
    colorists: ["Roman Titov", "Jason Wordie"],
    letterers: ["Hassan Otsmane-Elhaou"],
  ...
  {
    rank: 10,
    series_name: "Everything Dead and Dying",
    publisher: "Image Comics",
    writer: "Tate Brombal",
    artists: ["Jacob Phillips"],
    colorists: ["Pip Martin"],
